...
class Trainer():
    ...
    def train(self):  # training for all datasets
        ...
        self.writer.add_scalar('train_loss', loss_meter.avg, self.epoch+1)
        self.writer.add_scalar('train_loss1', loss1_meter.avg, self.epoch+1)
        self.writer.add_scalar('train_loss2', loss2_meter.avg, self.epoch+1)
