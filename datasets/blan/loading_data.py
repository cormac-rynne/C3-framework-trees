...
def loading_data():
    ...
    train_set = Blan(cfg_data.DATA_PATH, mode='train', main_transform=train_main_transform,
    ...
    val_set = Blan(cfg_data.DATA_PATH, mode='val', main_transform=None, img_transform=img_transform, gt_transform=gt_transform)
