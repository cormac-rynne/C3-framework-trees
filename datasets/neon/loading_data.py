...
def loading_data():
    ...
    train_set = Neon(cfg_data.DATA_PATH, mode='train', main_transform=train_main_transform,
    ...
    val_set = Neon(cfg_data.DATA_PATH, mode='val', main_transform=None, img_transform=img_transform, gt_transform=gt_transform)
