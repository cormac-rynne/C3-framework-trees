...
class Original(nn.Module):
    def __init__(self, test=False):
        ...
        self.up2 = Up_no_skip(512, 128)
        self.up3 = Up(256, 64) # Initialise half out for skip connections
        self.up4 = Up(128, 64) # Initialise half out for skip connections
...
class Up_no_skip(nn.Module):
    """
    Up-sampling using interpolation then double convolution, no skip connections used
    """
